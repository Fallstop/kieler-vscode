/* eslint-disable @typescript-eslint/no-explicit-any, no-console -- carried over from klighd-vscode */
/*
...
import { PersistenceMessage } from '../../src/diagram/storage/messages'
